...
static const char *chromium[]  = { "ungoogled-chromium", NULL };
...
static const Key keys[] = {
	...
	{ 0, 				XK_Print,  spawn, 	   SHCMD("maim --select | tee ~/Pictures/screenshots/$(date +%s).png | xclip -selection clipboard -t image/png") },
